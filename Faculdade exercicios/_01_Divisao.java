  ...
  public static void main (String entrada[])
    {
     ...
     x = n1 / n2; //Apesar do x ser double, por dividirmos dois inteiros o resultado é apenas o quociente inteiro sem resto
     System.out.println(x); //imprime no sistema o valor de x
     System.exit(0);
    }
}

//para executar esse programa no cmd devo digitar java Divisao argumento1 argumento2, exemplo: java Divisao 1 4. Nesse caso a entrada(0) recebe 1 e a entrada(1) recebe 4