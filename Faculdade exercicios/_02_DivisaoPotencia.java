...
public class _02_DivisaoPotencia {
    public static void main(String entrada[]) {
        ...
        n1 = Integer.parseInt(JOptionPane.showInputDialog("Digite um número inteiro "));//Solicita entrada na interface do usuário funciona com biblioteca importada no início
        n2 = Integer.parseInt(JOptionPane.showInputDialog("Digite outro número inteiro "));
        rediv = n1 / n2;
        pot = (int) Math.pow(n1, n2); // em java não tem operador para potência como 'n1**n2'
        msg = "O quociente da divisão de " + n1 + " por " + n2 + " é " + rediv + "\n O valor de " + n1 + " elevado a " + n2 + " é " + pot;
